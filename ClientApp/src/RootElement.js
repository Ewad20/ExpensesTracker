        ...
        {user && location.pathname === "/" && (
          <>
            <div className="mb-3">
              ...
              <p className="mt-2">
                <em>
                  Explore your dashboard and manage your financial activities
                  with ease.
                </em>
              </p>
              <div className="d-flex mt-3">
                ...
                <Link to="/export" className="link me-4">
                  <div className="dashboard-card">
                    <img
                      className="icons"
                      src="https://cdn-icons-png.flaticon.com/128/5859/5859742.png"
                      alt="Export Icon"
                    />
                ...
                <Link to="/transaction" className="link me-4">
                  <div className="dashboard-card">
                    <img
                      className="icons"
                      src="https://cdn-icons-png.flaticon.com/128/3186/3186858.png"
                ...
                <Link to="/" className="link">
                  <div className="dashboard-card">
                    <img
                      className="icons"
                      src="https://cdn-icons-png.flaticon.com/128/217/217905.png"
                      alt="Receipt Icon"
                    />
                ...
                <Link
                  to="/account/settings/twoFactorAuthentication"
                  className="link"
                >
                  <div className="dashboard-card">
                    <img
                      ...
                      alt="Receipt Icon"
                    />
                    <span>TwoFactorAuthentication</span>
                  </div>
                </Link>
              </div>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4">
              <div className="my-card">
                <img
                  className="my-icons"
                  src="https://cdn-icons-png.flaticon.com/128/4256/4256662.png"
                  alt="Icon"
                />
                <p className="my-card-text">
                  The Expense Tracker Application is designed to help you
                  effectively manage your finances with ease. Whether you're
                  tracking daily expenses, managing multiple wallets, or
                  organizing your financial transactions, this application
                  provides a comprehensive solution for your financial
                  management needs.
                </p>
              </div>
            </div>
